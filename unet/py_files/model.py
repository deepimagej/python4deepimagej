...
def jaccard_distance(y_true, y_pred, smooth=100):
    """Intersection-over-union loss (Jaccard distance)."""
...
def unet(input_size = (256,256,1), loss_ = 'binary_crossentropy', learning_rate = 1e-4, weight_decay = 5e-7):
    """
    ...
    model.compile(optimizer = Adam(lr = learning_rate, decay = weight_decay), loss = loss_, metrics = ['accuracy'])
